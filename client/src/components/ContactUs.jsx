                ...
                <div className="contact-us-section">
                    ...
                    <div className="contact-us-card">
                        <div className="contact-item">
                            ...
                            <a href="https://www.facebook.com/" className="contact-link">Ram Mandir Temple Facebook Page</a>
                        </div>
                        
                        <div className="contact-item">
                            <h3>Email:</h3>
                            <p>*Please be advised that Facebook Messenger is currently the best method of contact.*</p>
                            <a href="mailto:contact@rammandir.org" className="contact-link">contact@rammandir.org</a>
                        </div>
